    ...
    <>
        ...
        <a href="/" className="logo">Alexander.</a>
            ...
            <nav className='hidden lg:block'>
                ...
                <a href="/assets/images/CourseraMergedCerficates.pdf" download className='navbar-links'>Zertifikate <Image src={"/assets/images/download-solid-24.png"} width={20} height={20} className='bg-white rounded inline'/></a>
                ...
                <div className='flex'>
                    ...
                    {toggleDropdown && (
                        <div className='dropdown'>
                            ...
                            <a href="/assets/images/CourseraMergedCerficates.pdf" download onClick={() => setToggleDropdown(false)} className='dropdown_link'>Zertifikate <Image src={"/assets/images/download-solid-24.png"} width={20} height={20} className='inline'/></a>
