      ...
      <div className="relative z-10 pt-3 md:pt-0 md:top-1/4 lg:top-1/3 max-w-7xl mx-auto flex flex-col lg:flex-row">
        <div className="max-w-2xl px-4 flex flex-col gap-8  max-xl:bg-black/60 max-xl:rounded-lg">
          ...
          <p className="text-white text-base max-w-xl md:text-xl">
            Seit Beginn meiner Programmier-Reise habe ich viel gelernt und
            eigene Projekte entwickelt. Ich arbeite selbstständig, liebe neue
            Herausforderungen und wachse mit jedem Code, den ich schreibe. Hier
            sind einige GitHub Links meiner Werke.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 m-4">
          ...
          <div>
            <a
              href="https://github.com/NoShare16/Deep_Blog"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="relative overflow-hidden rounded-xl transition duration-300 ease-in-out transform hover:scale-105">
                <Image
                  src="/assets/images/AiMakingMoney.jpg"
                  alt="Link to Github"
                  width={500}
                  height={500}
                />
          ...
          <div>
            <a
              href="https://ai-prompt-collection.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="relative overflow-hidden rounded-xl transition duration-300 ease-in-out transform hover:scale-105">
                <Image
                  src="/assets/images/PersonTalkingAi.jpg"
          ...
          <div>
            <a
              href="https://github.com/NoShare16/Beginner-Projects"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="relative overflow-hidden rounded-xl transition duration-300 ease-in-out transform hover:scale-105">
                <Image
                  src="/assets/images/TeachingAi.jpg"
                  alt="Link to Github"
                  width={500}
                  height={500}
                />
